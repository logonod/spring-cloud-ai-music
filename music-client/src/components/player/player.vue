  ...
  <div class="player" v-show="playlist.length>0">
    ...
    >
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="top">
          ...
          <h2 class="subtitle" v-html="`原唱: ${currentSong.artist} 翻唱: ${currentSong.ai}`"></h2>
        </div>
        <div class="middle"
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img :class="cdCls" :src="currentSong.cover" width="40" height="40">
        </div>
        <div class="text">
          <h2 class="name" v-html="currentSong.title"></h2>
          <p class="desc" v-html="`原唱: ${currentSong.artist} 翻唱: ${currentSong.ai}`"></p>
        </div>
        <div class="control">
...
export default {
  ...
  watch: {
    currentIndex(newIndex) {
      this.songSrc = `http://d.liuzeyu.me/${this.playlist[newIndex].hash}.wav`
    },
